				...
				if ($resql) {
					...
					if ($obj) {
						...
						if (empty($confirmduplicate)) {
							...
							///$ret=-1;
                                                        // Un homonyme n'est pas nécessairement un doublon.
                                                        // On avertit l'utilisateur, mais on autorise la création.
                                                        setEventMessage(
                                                            'Attention : un patient portant le nom « '.
                                                            dol_escape_htmltag($nametocheck).
                                                            ' » existe déjà. Vérifiez la date de naissance et le téléphone.',
                                                            'warnings'
                                                        );
						}
					} else {
